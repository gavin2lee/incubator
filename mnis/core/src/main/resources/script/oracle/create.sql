...
CREATE TABLE DOC_FALL_
(
   ID_            VARCHAR (64),
   DOC_           VARCHAR (64),
   DATE_          VARCHAR (64),
   AGE65TO75_     VARCHAR (10),
   AGE_GT75_      VARCHAR (10),
   HISTORY_       VARCHAR (10),
   MOVE_LOSS_     VARCHAR (10),
   MOVE_ASSIST_   VARCHAR (10),
   DIZZY_         VARCHAR (10),
   SIGHT_         VARCHAR (10),
   DRUG_          VARCHAR (100),
   EXCRETION_     VARCHAR (10),
   SLEEP_         VARCHAR (10),
   ILL_           VARCHAR (100),
   CURE_          VARCHAR (100),
   SCORE_         VARCHAR (10),
...
CREATE TABLE DOC_FALL_NURSE_
(
   ID_          VARCHAR (64),
   DOC_         VARCHAR (64),
   DATE_        VARCHAR (64),
   DRY_         VARCHAR (10),
   FAMILIAR_    VARCHAR (10),
   WARN_        VARCHAR (10),
   STAFF_       VARCHAR (10),
   BED_         VARCHAR (10),
   CALL_        VARCHAR (10),
...
CREATE TABLE DOC_BADL_
(
   ID_          VARCHAR (64),
   DOC_         VARCHAR (64),
   DATE_        VARCHAR (64),
   DEFECATE1_   VARCHAR (10),
   DEFECATE2_   VARCHAR (10),
   DEFECATE3_   VARCHAR (10),
   PEE1_        VARCHAR (10),
   PEE2_        VARCHAR (10),
   PEE3_        VARCHAR (10),
   ATTIRE1_     VARCHAR (10),
...
CREATE TABLE DOC_PRESS2_
(
   ID_              VARCHAR (64),
   DOC_             VARCHAR (64),
   DATE_            VARCHAR (64),
   COORDINATE4_     VARCHAR (10),
   COORDINATE3_     VARCHAR (10),
   COORDINATE2_     VARCHAR (10),
   COORDINATE1_     VARCHAR (10),
   AGE4_            VARCHAR (10),
   AGE3_            VARCHAR (10),
   AGE2_            VARCHAR (10),
   AGE1_            VARCHAR (10),
   ...
   ILL2_            VARCHAR (10),
   ILL1_            VARCHAR (10),
   PHYSIOLOGY4_     VARCHAR (10),
   PHYSIOLOGY3_     VARCHAR (10),
   PHYSIOLOGY2_     VARCHAR (10),
   PHYSIOLOGY1_     VARCHAR (10),
   AWARE4_          VARCHAR (10),
   AWARE3_          VARCHAR (10),
   AWARE2_          VARCHAR (10),
   AWARE1_          VARCHAR (10),
   ...
   MOVE2_           VARCHAR (10),
   MOVE1_           VARCHAR (10),
   AGILITY4_        VARCHAR (10),
   AGILITY3_        VARCHAR (10),
   AGILITY2_        VARCHAR (10),
   AGILITY1_        VARCHAR (10),
   INCONTINENCE4_   VARCHAR (10),
   INCONTINENCE3_   VARCHAR (10),
   INCONTINENCE2_   VARCHAR (10),
   INCONTINENCE1_   VARCHAR (10),
   SCORE_           VARCHAR (10),
   SIGN_            VARCHAR (100),
   USER_CODE_       VARCHAR (64),
   DEPT_CODE_       VARCHAR (64),
