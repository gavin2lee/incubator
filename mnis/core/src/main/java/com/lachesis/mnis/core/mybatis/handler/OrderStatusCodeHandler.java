...
public class OrderStatusCodeHandler implements TypeHandler<String> {
	@Override
	...
	public String getResult(ResultSet rs, String columnName)
		...
		return OrderUtil.getOrderStatusCode(orderStatus);
//		return OrderUtil.processOrderStatusCode(orderStatus);
	}
