 ...
 *
 */
public class NurseWhiteBoardMetadata {
	/**
	 * 主键id
	 */
	private int id;
	...
	private List<NurseWhiteBoardEditType> nurseWhiteBoardEditTypes;

	private List<NurseWhiteBoardMetadata> items;
	...
	public List<NurseWhiteBoardMetadata> getItems() {
		return items;
	}

	public void setItems(List<NurseWhiteBoardMetadata> items) {
		this.items = items;
	}
	...
	public List<NurseWhiteBoardEditType> getNurseWhiteBoardEditTypes() {
		return nurseWhiteBoardEditTypes;
	}

	public void setNurseWhiteBoardEditTypes(
			List<NurseWhiteBoardEditType> nurseWhiteBoardEditTypes) {
		this.nurseWhiteBoardEditTypes = nurseWhiteBoardEditTypes;
	}
