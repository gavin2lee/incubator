...
@Component("skinTestNotifyService")
public class SkinTestNotifyServiceImpl extends AbstarctNotifyService {
	private Logger LOGGER = LoggerFactory
			.getLogger(SkinTestNotifyServiceImpl.class);
	...
	public void doNotify(String userId) {
		...
		LOGGER.info("Do skintest Notify For User: " + userId);
		...
		String channel = RedisConstants.CNL_SKIN_TEST + deptCode + ".*";
