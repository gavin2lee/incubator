	...
	<template:replace name="content-body">
        ...
        <div class="plate">
            <div class="project_r">
                ...
                <input value="${paasProjectBuild.imageName}"  type="hidden" name="imageName"  id="imageName" />
                <div class="r_block p20">
                	<c:if test="${project.projectType !='api' && project.projectType!='app' }">
	                    <div class="r_block">
	                        <div class="r_title">
	                            <h3 class="f14 h3_color h3_btm_line"><i class="icons add_ico_blue mr5"></i>修改构建镜像</h3>
	                        ...
	                        <div class="r_con p10_0">
	                            <div class="form_control p20">
	                                ...
	                                <div class="form_block"  style="display: none;">
	                                    <label>构建名称</label>
	                                    <input type="text" name="buildName" value="${paasProjectBuild.buildName }">
	                                </div>
	                                <div class="form_block" style="display: none;">
	                                    <label>构建tag</label>
	                                    <input id="buildTag" class="w200" type="text" name="buildTag" value="${paasProjectBuild.buildTag }">
	                                </div>
	                                <div class="form_block">
	                                    <label>镜像端口</label>
	                                    <div class="specList">
	                                        <table id="portList" class="table_creat">
	                                            <tbody><tr>
	                                                ...
	                                                <th>关键字</th>
	                                                <th>协议</th>
	                                                <th style="display: none;">说明</th>
	                                                <th style="display: none;">
	                                                	<a class="addRow btn btn-default btn-yellow btn-sm" href="javascript:void(0);"><em class="f14">+</em></a>
	                                                </th>
	                                            </tr>
	                                            <tr class="row-data">
	                                                <td><input  name="port"  type="text" class="u-ipt row-td"></td>
	                                                <td><input name="key" type="text" class="u-ipt row-td"></td>
	                                                <td>
	                                                	<select name="protocol"  class="u-ipt2 row-td">
	                                                		<option value="tcp">TCP</option>
	                                                		<option value="udp">UDP</option>
	                                                	</select>
	                                                </td>
	                                                <td style="display: none;"><input name="remark" type="text" class="u-ipt2 row-td"></td>
        ...
        <script>
        	$(function(){
				...
				//数据初始化
				var versionId = '${paasProjectBuild.versionId}';
				$('#buildVersion').val(versionId);
				$('#buildVersion').trigger('change');
				var filePath = '${paasProjectBuild.filePath}';
				$('#buildFile').val(filePath);
				$('#buildFile').trigger('change');
				...
				$('#portList').find('.row-data').remove();
				for(var i=0;i<port.length;i++){
					$('.addRow').trigger('click',[port[i]]);
				}
        	});
        </script>
	</template:replace>
