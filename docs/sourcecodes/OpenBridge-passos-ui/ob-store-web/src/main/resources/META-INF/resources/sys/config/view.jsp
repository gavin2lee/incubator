...
<template:include file="./base.jsp"  active="view" >
	...
	<template:replace name="detail-info">
		<form action="${WEB_APP_PATH}/sys/config/save.do" enctype="application/x-www-form-urlencoded" method="post">
			...
			<div class="line3"></div>
                    <c:import url="./paasos/build.jsp"></c:import>
					<c:import url="./paasos/registry.jsp"></c:import>
					<c:import url="./paasos/cluster.jsp"></c:import>
					<c:import url="./paasos/monitor.jsp"></c:import>
					<c:import url="./paasos/webssh.jsp"></c:import>
