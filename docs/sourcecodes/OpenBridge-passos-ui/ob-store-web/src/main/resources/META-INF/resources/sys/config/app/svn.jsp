...
<div class="form_control form_control_setting p20">
                            <div class="form_block">
                                ...
                                <div class="form-right">
                                  <input type="text" style="width: 400px;" value="${ config['app.svn.url'] }" name="config['app.svn.url']" />
                            ...
                            <div class="form_block">
                                ...
                                <div class="form-right">
                                    <input type="text"  style="width: 400px;" value="${ config['app.svn.hostip'] }" name="config['app.svn.hostip']" />
