...
<template:include file="./base.jsp" active="monitor">
...
.table td input {
	width: 90%;
			...
			<form action="${WEB_APP_PATH}/sys/config/monitorsave.do"
				enctype="application/x-www-form-urlencoded" method="post">
				<div class="r_block">
					<div class="r_con p10_0">
						<c:import url="./conf/monitor.jsp"></c:import>
						<c:import url="./conf/log.jsp"></c:import>
