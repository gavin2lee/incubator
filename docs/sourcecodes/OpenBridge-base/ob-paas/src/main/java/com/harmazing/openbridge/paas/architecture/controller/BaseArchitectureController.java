package com.harmazing.openbridge.paas.architecture.controller;
...
@Controller
@RequestMapping("/sys/architecture")
public class BaseArchitectureController {
	
	private static Log logger = LogFactory
			.getLog(BaseArchitectureController.class);
	
	@Autowired
	private IArchitectureService iArchitectureService;
	
	@RequestMapping("/index")
	public String index(HttpServletRequest request, HttpServletResponse response){
		return "/sys/architecture/index";
	}
