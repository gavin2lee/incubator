...
<title>mnisqm Setup Assistant Page</title>
</head>
...
<div id="container">
        ...
        <div class="header-mid">
                <table width="100%" height="100%" align="center" valign="center">
                   <tbody>
                     <tr>
                        <td>
                            <a href="https://www.mnisqm.com">
                                <img src="${defaultUrls.cdn_url}icons/logo_mycollab_2.png" alt="mnisqm">
                            </a>
                        </td>
                        <td>
    ...
    <div id="body">
        ...
        <div id="mainBody">
            ...
            <div id="title">
                <h3>Welcome to the mnisqm setup wizard. Please fill in the information below to complete the installation process.</h3>
                <h4>mnisqm is well tested on various platforms include Windows, Linux and MacOS. We have been
                spending countless hours to do the installation testing on
                as many machines as possible. If you can not install mnisqm successfully, please raise your case in
                 our <a href="http://support.mnisqm.com/list/42580-general-help/" target="_blank">Support
                 page</a></h4>
            </div>
            ...
            <div id="mainContent">
                <table style="width:100%">
                    <tr>
                        <td style="vertical-align: top; width: 400px;"><div style="margin-top:10px;">mnisqm SETUP </div>
                            ...
                            <form>
                                <table border="0" style="width:100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input id="sitename" value="mnisqm"/></td>
                                        </tr>
                                        ...
                                        <tr><td><h4>You can get this info from your web host. It could be an IP address or server name. You must not include the server port in this value. If you want to change the server port, please use <a href="https://community.mnisqm.com/faq/#defaultport">this way</a></h4></td></tr>
                                    </tbody>
                                </table>
                            </form>
                        </td>
                ...
                <table style="width:100%;margin-top: 20px;">
                    <tr>
                        <td style="vertical-align: top; width: 400px;"><div style="margin-top:10px;">DATABASE SETUP</div>
                            <h4>Configure your pre-created mnisqm database schema</h4>
                        </td>
                        <td style="display: inline-block; vertical-align: top; width:100%">
                            <form>
                                <table border="0" style="width:100%">
                                    <tbody>
                                        ...
                                        <tr><td><h4>Name of mnisqm database. Database must be created before.</h4></td></tr>
                ...
                <table style="width:100%;margin-top: 20px;">
                    <tr>
                        <td style="vertical-align: top; width: 400px;"><div style="margin-top:10px;">EMAIL SETUP (Optional)<div>
                            <h4>Configure your outgoing SMTP email address to use with the software. You can configure your SMTP account later in mnisqm configuration file ${MYCOLLAB_HOME}/conf/mnisqm.properties</h4>
                        </td>
                        <td style="display: inline-block; vertical-align: top; width:100%">
                            <form>
                                <table border="0" style="width:100%">
            ...
            <div id="bottom">
                <p>
                    <a javascrip="void(0);" href="https://www.mnisqm.com" style="text-decoration : none;
                    float:left"><span>&copy; 2015 mnisqm. All rights reserved.</span></a>

                    <div style="text-align:right;">
                    <a javascrip="void(0);" href="https://www.mnisqm.com/terms" style="text-decoration : none;"><span>Terms of Service</span></a> &nbsp;&nbsp;&nbsp;
                    <span>|</span>
                    &nbsp;&nbsp;&nbsp;<a javascrip="void(0);" href="https://www.mnisqm.com/privacy" style="text-decoration : none;"><span>Privacy Policy</span></a>
                    </div>
                </p>
            </div>
        </div>
...
function updateInfoAction(){
    ...
    $('#setupBtn').after('<p><h3 style=\"color:orange\">Please be patient! It may takes several minutes to set up mnisqm depends on your servers performance. Whenever the install process is completed, the browser is redirected automatically to the application home page</h3></p>');
    var urlPost = "/install";
