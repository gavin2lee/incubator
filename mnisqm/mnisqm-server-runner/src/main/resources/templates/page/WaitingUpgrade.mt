...
<title>mnisqm is upgrading ...</title>
</head>
<body style="height: 100%; margin: 0; padding: 0; width: 100%;">
	<div id="container">
		...
		<div id="body">
			...
			<div id="mainBody">
				<div id="title">
					<h1 style="font-size:40px; margin-bottom:15px;">mnisqm is upgrading ...<h1>
				</div>
				...
				<div id="bottom">
				    <p>
						...
						float:left"><span>Copyright 2015 mnisqm. All rights reserved.</span></a>
        ...
        success: function(data) {
          if(data!=null){
            if(data.length > 0) {
              ...
              alert("mnisqm is upgraded successfully. Redirect to the app?");
