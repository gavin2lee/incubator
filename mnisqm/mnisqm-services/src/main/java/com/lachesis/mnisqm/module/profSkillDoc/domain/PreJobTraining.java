...
public class PreJobTraining {
	...
	private String assessmentCondition;
	...
	public String getAssessmentCondition() {
		return assessmentCondition;
	}

	public void setAssessmentCondition(String assessmentCondition) {
		this.assessmentCondition = assessmentCondition;
	}
