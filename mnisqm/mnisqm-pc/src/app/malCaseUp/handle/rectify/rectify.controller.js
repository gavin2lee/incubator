(function() {
  ...
  angular
    .module('nqms')
    .controller('MalCaseUpRectifyController', rectifyControllerFun);

  function rectifyControllerFun($rootScope, $scope, $log, $q, $stateParams, security, levelService, modalService, toastr, fixService, deptService, handleService, filesService) {
    var vm = this;
    var formData = {};
    var metaData = {};
